...
const routes: Routes = {
  ...
  [Pages.ArticleOverview]: {
    component: asyncComponentLoader(() => import('@/pages/JourneyArticleOverview')),
    path: '/admin/articleoverview',
  ...
  [Pages.IntroOverview]: {
    component: asyncComponentLoader(() => import('@/pages/IntroOverview')),
    path: '/admin/introoverview',
